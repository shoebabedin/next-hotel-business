...
import logo2 from "/public/assets/images/logo/logo-2.webp";
...
const NavBar = () => {
  ...
  return (
    <>
      <nav
        className={`nav z-50 ${isOpen && "is-active"} ${
          stickyNav ? "sticky" : ""
        } ${page && "homeNav"}`}
      >
        <div className="container mx-auto px-2">
          <div className="flex items-center justify-between h-16">
              ...
              <div className="flex-shrink-0">
                {page ? (
                  stickyNav ? (
                    <Link href="/">
                      <span className="logo">
                        <Image src={logo2} alt="" width="154px" height="48px" />
                      </span>
                    </Link>
                  ) : (
                    <Link href="/">
                      <span className="logo">
                        <Image src={logo} alt="" width="154px" height="48px" />
                      </span>
                    </Link>
                  )
                ) : (
                ...
                <div className="flex items-center">
                  <Link href="/">
                    <a
                      className={`${
                        page
                          ? "text-white/[.6] hover:text-white/[1]"
                          : "text-[#0f0e0e]/30"
                      } ${
                        asPath.route === "/" ? "active" : ""
                      } flex flex-row items-center px-3 py-2 text-sm font-medium rounded-md focus:outline-none relative link`}
                    >
                  ...
                  <Link href="events">
                    <a
                      ...
                      className={` flex flex-row items-center px-3 py-2 text-sm font-medium rounded-md focus:outline-none relative link ${
                        page
                          ? "text-white/[.6] hover:text-white/[1]"
                          : "text-[#0f0e0e]/30"
                      } ${asPath.route === "/events" ? "!text-[#be9e57]" : ""}`}
                    >
                    ...
                    <Menu.Button
                      className={`${
                        page
                          ? "text-white/[.6] hover:text-white/[1]"
                          : "text-[#0f0e0e]/30"
                      } flex flex-row items-center px-3 py-2 text-sm font-medium  rounded-md focus:outline-none link no-underline`}
                    >
                    ...
                    >
                      <div className="absolute right-0 mt-6 w-max origin-top-right rounded-md shadow-lg z-20">
                        <div className="py-10 bg-white/80 backdrop-blur-md rounded-md shadow-xs ">
                          <Link href="food-corner">
                            <a
                              className="flex flex-row items-center gap-2 px-16 py-2 mt-1 t rounded-md text-[#0F0E0E] text-sm font-bold capitalize hov_effect"
                              role="menuitem"
                            >
                              <CookingPot
                                size={32}
                          ...
                          <Link href="bar">
                            <a
                              className="flex flex-row gap-2 items-center px-16 py-2 mt-1 rounded-md text-[#0F0E0E] text-sm font-bold capitalize hov_effect"
                              role="menuitem"
                            >
                              <Storefront
                                size={32}
            ...
            <div className="hidden lg:block">
              <div className="flex items-center ml-4 md:ml-6">
                <div className="question hidden lg:block lg:basis-auto">
                  <div
                    className={`${
                      page ? "border-white" : "text-[#0f0e0e] border-[#0f0e0e]"
                    } border  shadow rounded-md max-w-sm w-full mx-auto p-3`}
                  >
            ...
            <div className="relative flex lg:hidden">
              <div
                onClick={navShow}
                className="inline-flex items-center justify-center p-2 text-gray-400 rounded-md hover:text-white hover:bg-black focus:outline-none focus:bg-black bg-black focus:text-white cursor-pointer"
              >
                {mobNavShow ? (
        ...
        {mobNavShow && (
          <div className="drop-shadow-2xl lg:hidden bg-white/[.9] absolute mob_nav rounded-bl-[10px] z-20">
            <div className="container mx-auto">
              <div className="pt-2 pb-3">
                <Link href="/">
                  <a className={`${asPath.route === "/" ? "text-[#BE9E57]" : "text-[#0F0E0E]"} flex flex-row items-center px-3 py-2 rounded-md text-base font-semibold capitalize md:border-0 border-b`}>
                    <span className="ml-2">Home</span>
                  </a>
                </Link>
                <Link href="room">
                  <a className={`
                      ${asPath.route === "/room" ? "text-[#BE9E57]" : "text-[#0F0E0E]"} flex flex-row items-center px-3 py-2 rounded-md text-base font-semibold capitalize md:border-0 border-b`}>
                    <span className="ml-2">Rooms</span>
                  </a>
                </Link>
                <div className="relative">
                  <button
                    onClick={dropDown}
                    className={`flex flex-row items-center px-3 py-2 mt-1 rounded-md text-[#0F0E0E] lg:text-white text-base font-semibold capitalize md:border-0 border-b w-full justify-between cursor-pointer`}
                  >
                    <span className="mx-2">Services</span>
                    {show ? (
                  ...
                  {show && (
                    <div className="px-2 py-2 mt-2 bg-white rounded-md shadow-xs pl-20 mobile_drop">
                      <Link href="food-corner">
                        <a className={`${asPath.route === "/food-corner" ? "text-[#BE9E57]" : "text-[#0F0E0E]"} flex flex-row gap-2 items-center px-3 py-2 mt-1 rounded-md text-sm font-semibold capitalize`}
                          role="menuitem"
                        >
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                      ...
                      <Link href="fitness">
                        <a
                          ...
                          className={`${asPath.route === "/fitness" ? "text-[#BE9E57]" : "text-[#0F0E0E]"} flex flex-row gap-2 items-center px-3 py-2 mt-1 rounded-md text-sm font-semibold capitalize`}
                          role="menuitem"
                        >
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                      ...
                      <Link href="pool">
                        <a className={`${asPath.route === "/pool" ? "text-[#BE9E57]" : "text-[#0F0E0E]"} flex flex-row gap-2 items-center px-3 py-2 mt-1 rounded-md text-sm font-semibold capitalize`}
                          role="menuitem"
                        >
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                      ...
                      <Link href="bar">
                        <a className={`${asPath.route === "/bar" ? "text-[#BE9E57]" : "text-[#0F0E0E]"} flex flex-row gap-2 items-center px-3 py-2 mt-1 rounded-md text-sm font-semibold capitalize`}
                          role="menuitem"
                        >
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                ...
                <Link href="events">
                  <a className={`${asPath.route === "/events" ? "text-[#BE9E57]" : "text-[#0F0E0E]"} flex flex-row items-center px-3 py-2 rounded-md text-base font-semibold capitalize md:border-0 border-b`}
                  >
                    <span className="ml-2">Events</span>
                  </a>
                </Link>
                <Link href="contact">
                  <a className={`${asPath.route === "/contact" ? "text-[#BE9E57]" : "text-[#0F0E0E]"} flex flex-row items-center px-3 py-2 rounded-md text-base font-semibold capitalize md:border-0 border-b`}
                  >
