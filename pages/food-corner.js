...
const FoodCorner = () => {
  ...
  useEffect(() => {
    fetch("/json/FoodTabs.json")
      .then((res) => res.json())
      .then((data1) => setData1(data1));
  }, []);
  
  useEffect(() => {
    fetch("/json/HotelFood.json")
      .then((res) => res.json())
      ...
      <div className="details_banner">
        <section className="hotel_banner mt-6">
          <div className="container mx-auto px-2 pb-2">
            <DetailsPageSlider slider={data2} />
                ...
                <div className="grid grid-cols-12 gap-4">
                  <div className="col-span-12 lg:col-span-10 lg:mr-28">
                    ...
                    <p className="font-normal text-sm lg:text-base text-[#0e0e0e]">
                      Driven by 
                      <b className="lobster capitalize mx-1">
                         Hotel Grand Prince
                        <span className="text-red-700">.</span>
                      </b>
                      The Restaurant is commended for its phenomenal food and
                      one of a kind climate. The perfect lounge area highlights
                      three open studio kitchens, permitting you to partake in
                      the sights and hints of the culinary imaginativeness in
                      plain view.
                      <br />
                      <br />
                      The menu exhibits both Asian and European impacts, with an
                      enticing determination of exemplary top picks and
                      imaginative dishes for you to test. Cheddar specialists
                      will be attracted to The Wine and Cheese Cellar, housed in
                      five-meter-high glass dividers, where our learned staff
                      can acquaint you with some of New York &apos;s most noteworthy
                      culinary fortunes.
                    </p>
                        ...
                        <div className="flex items-center space-x-4 py-2">
                          ...
                          <div className="flex-1 space-y-6 py-0.5">
                            ...
                            <Link
                              ...
                              href="tel:3104372766"
                            >
                              <a className="text-white font-bold text-sm">310-437-2766</a>
                            </Link>
                          </div>
                        </div>
                      </div>
            ...
            <div className="grid grid-cols-12 gap-4">
              ...
              <div className="col-span-12">
                ...
                <div className="basis-full w-full md:basis-5/12 case_study element-item asia col-span-12 lg:col-span-6 pb-6 -mb-8 border-b-neutral-200 border-opacity-10">
                  ...
                  >
                    {data1?.map(({ id, tab, item }) => {
                      return (
                        <li
                          key={id}
                          class="button lg:text-base text-sm font-semibold text-white opacity-50 !opacity-100 border-b"
                        >
                  ...
                  {data1.map(({ id, tab, item }) => {
                    return (
                      id === tabBtn && (
                        <div id="tab-contents">
                          <div className="content grid gap-16 grid-cols-12 overflow-x-hidden">
                            {item.map(({ id, img, desc, title, price }) => {
                              return (
                                <div
                                  key={id}
                                  className="col-span-12 lg:col-span-6 case_study element-item asia pb-6 border-b border-b-neutral-200 border-opacity-10"
                                >
        ...
        <Clients />
        <Destination heading={"Our Popular Food"} slider2={data2} />
      </div>
    </>
  );
};
